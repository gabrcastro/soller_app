...
export const PowerNeed = () => {
  return (
    <div className="w-full h-auto p-3 bg-[#7E22CE] flex flex-col gap-4 items-center justify-center relative">
      <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-between mt-14 lg:px-10 xl:px-2">
        ...
        <div className="flex lg:hidden bg-[#A252EE] h-[550px] w-[550px] rounded-full absolute bottom-0 left-0 -mb-44 -ml-56" />
      ...
      <div className="relative w-full h-[700px] overflow-hidden -mt-10">
        <Image
          ...
          width={1080}
          height={1080}
          className="absolute scale-[.85] left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 lg:-mt-0 "
        />
      </div>
    </div>
  );
