...
export const PowerfullFeatures = () => {
  return (
    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between w-full h-full md:-mt-[70%] lg:mt-[2%]">
      <div className="px-4 ml-0 lg:ml-14 flex flex-col items-center justify-center lg:justify-start w-full h-full mt-24 md:mt-[80%] lg:-mt-16 mr-10 -mb-0 lg-mb-96 lg:-mb-0">
        <SessionComponent
      ...
      <Image
        ...
        width={1080}
        height={1080}
        className="flex scale-[1.3] sm:scale-[1] md:scale-[1.2] lg:scale-[1] -mr-[10rem] sm:-mr-[20rem] lg:-mr-[46%] xl:-mr-[40%] my-32 mt-14 sm:mt-10 md:mt-20 lg:mt-0 ml-[10rem] sm:ml-[14rem] md:ml-[22rem] lg:ml-0"
