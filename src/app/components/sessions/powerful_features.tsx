...
export const PowerfullFeatures = () => {
  return (
    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between w-full h-auto relative -mt-[160%] sm:-mt-[90%] md:-mt-[70%] lg:-mt-[30%]">
      <div className="px-4 ml-0 lg:ml-14 flex flex-col items-center justify-center lg:justify-start w-full mt-44 lg:mt-10 relative mr-10">
        <SessionComponent
      ...
      <div className="relative w-screen h-[1200px] lg:h-[1000px] overflow-hidden my-20">
        <Image
          src={"/draws/draw3.svg"}
          alt="Draw 1"
          width={1080}
          height={1080}
          className="absolute scale-[1.4] sm:scale-[1] lg:scale-[1.2] -mr-[10rem] lg:-mr-72 right-1/2 top-1/2 transform translate-x-1/2 -translate-y-1/2 -mt-72 sm:-mt-56 lg:mt-0"
        />
      </div>
    </div>
  );
