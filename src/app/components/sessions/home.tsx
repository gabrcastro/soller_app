  ...
  return (
    <div className="w-screen relative">
      ...
      <Image
        ...
        width={512}
        height={512}
        className="w-[90%] h-auto lg:w-[46%] xl:w-[36%] lg:h-auto absolute top-0 right-0"
      />
      <div className="w-full lg:w-[60%] flex flex-col mt-[65%] lg:-mt-72 items-center lg:items-start justify-center lg:justify-start p-8">
        <h2 className="flex lg:hidden text-6xl w-[60%] lg:w-auto font-bold text-[#0F172A] text-center mt-60 md:mt-72">
          {Constants.GET_SUN}
        </h2>
        ...
        <p className="flex lg:hidden text-4xl lg:text-base w-[80%] lg:w-auto font-normal text-[#0F172A] text-center lg:text-start my-14 lg:my-6">
      ...
      <div className=" flex flex-col w-full p-8 mt-14 xl:mt-0">
        <p className="text-3xl lg:text-lg w-[80%] lg:w-[50%]">
          {Constants.COMMENT}
        </p>
        <UserComponent
      ...
      <div className="w-full flex flex-col items-center justify-center">
        <SessionComponent
          ...
          centered
        />
        <div className="relative w-screen h-[1000px] overflow-hidden -mt-28">
          <Image
            src={"/draws/draw1.svg"}
            alt="Draw 1"
            width={1080}
